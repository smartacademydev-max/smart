...
export default function AllQuestionListing({ open, setOpen }: Props) {
        ...
        <div className='all__question__root h-full flex flex-col justify-between'>
            <div className="page__top">
                <PageHeader
                    breadcrumb={[
                        {
                            title: t("menus.test_question_management.question.root"),
                    ...
                    cta={
                        {
                            icon: <Add />,
                            url: "",
                            label: t("messages.empty_states.question.action"),
                        }
                    }
