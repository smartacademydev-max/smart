...
import { useArchiveStudentFromBundleMutation, useGetEnrolledStudentsByBundleQuery } from "../../../../services/questionApi";
...
import EnrollStudentToBundleForm from "./EnrollStudentToBundleForm";

export default function BundleEnrolledStudents({ id }: { id: number }) {
    ...
    return (
        <div className="user__root">
            ...
            <EnrollStudentToBundleForm open={open} setOpen={setOpen} id={id} />
